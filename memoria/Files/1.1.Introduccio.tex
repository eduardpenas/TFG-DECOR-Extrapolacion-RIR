...
La extrapolación de respuestas impulsionales de sala es un problema relevante porque sintetizar la reverberación tardía influye directamente en la calidad final del audio y en la utilidad de las simulaciones acústicas. Los métodos geométricos clásicos, aunque están bien fundamentados físicamente, pueden ser costosos cuando se necesita producir muchas respuestas o trabajar con tiempos de cálculo ajustados.
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Mejora verificable frente a una señal estocástica de referencia \textit{naive} en métricas físicas como $T_{60}$ y DRR.
        \item Consistencia espectral en múltiples resoluciones de STFT.
    \end{itemize}

    \item \textbf{Requisitos del Entrenamiento}
    \begin{itemize}
        \item Estabilidad del entrenamiento de principio a fin, sin errores que paren el proceso.
        \item Reproducibilidad de los resultados al repetir el experimento en las mismas condiciones.
        \item Integración automática de la mejor versión del modelo durante el entrenamiento.
    \end{itemize}
\end{itemize}
