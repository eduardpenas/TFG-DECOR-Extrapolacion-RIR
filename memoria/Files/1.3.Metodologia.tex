...
De forma general, la parte tardía suele modelarse de forma aproximada como un proceso aleatorio modulado por una envolvente exponencial decreciente. Esta hipótesis explica por qué la fase puntual de la cola es difícil de predecir, mientras que sus propiedades energéticas globales sí pueden modelarse de forma estable \cite{DEFRANCE2010777}.
...
La aproximación implementada se expresa mediante una arquitectura codificador-decodificador, donde el codificador extrae una representación latente y el decodificador reconstruye la parte tardía estimada.
