...
En cuanto a latencia, DECOR tarda 5.36 ms por inferencia y presenta un RTF de 0.0056. Esto significa que, con hardware acelerado, puede generar la cola reverberante más de 170 veces más rápido que el tiempo real. En la práctica, esto facilita su integración en motores de audio para videojuegos y en sistemas de realidad virtual, donde una latencia baja es clave para mantener la inmersión.
En resumen, el modelo ofrece buen rendimiento acústico y, además, es viable a nivel computacional para uso práctico.
